/**
 * please.js
 * A small and modern ajax lib
 * Forked from atomic.js by @toddmotto
 * .js 5.0K
 * .min.js 2.1K
 * .min.js.gz 963B
 * Author: @heydanreeves
